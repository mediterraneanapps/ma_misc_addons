    ...
    TimeLog.Widget = Widget.extend(ServiceProviderMixin, {
        ...
        add_favicon: function() {
            if (this.status === 'stopped') {
                $('link[type="image/x-icon"]').attr('href', '/ma_project_timelog/static/src/img/favicon_play.ico');
            } else if (this.status === 'running') {
                $('link[type="image/x-icon"]').attr('href', '/ma_project_timelog/static/src/img/favicon_stop.ico');
            }
        },
        updateView: function() {
