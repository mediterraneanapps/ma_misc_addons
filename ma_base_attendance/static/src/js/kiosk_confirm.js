...
var KioskConfirm = AbstractAction.extend({
    ...
    init: function (parent, action) {
        ...
        this.next_action = 'ma_base_attendance.hr_attendance_action_kiosk_mode';
    ...
    start: function () {
        var self = this;
        this.getSession().user_has_group('ma_base_attendance.group_hr_attendance_use_pin').then(function(has_group){
...
core.action_registry.add('ma_base_attendance_kiosk_confirm', KioskConfirm);
