...
class HrPartner(models.Model):
    ...
    def attendance_scan(self, barcode):
        ...
        return partner and partner.attendance_action('ma_base_attendance.hr_attendance_action_kiosk_mode') or \
    ...
    def attendance_manual(self, next_action, entered_pin=None):
        ...
        if not (entered_pin is None) or \
                self.env['res.users'].browse(SUPERUSER_ID).has_group('ma_base_attendance.group_hr_attendance_use_pin'):
    ...
    def attendance_action(self, next_action):
        ...
        """
        self.ensure_one()
        action_message = self.env.ref('ma_base_attendance.hr_attendance_action_greeting_message').read()[0]
